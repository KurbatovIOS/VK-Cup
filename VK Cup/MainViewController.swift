...
class MainViewController: UIViewController {
    ...
    private var categories = ["Спорт", "Компьютерные игры", "Кино", "Музыка", "Мультфильмы", "Путешествия", "Природа", "Еда", "Юмор", "Новости", "Рестораны", "Животные", "Театры", "Сериалы", "Спорт", "Компьютерные игры", "Кино", "Музыка", "Мультфильмы", "Путешествия", "Природа", "Еда", "Юмор", "Новости", "Рестораны", "Животные", "Театры", "Сериалы"]
